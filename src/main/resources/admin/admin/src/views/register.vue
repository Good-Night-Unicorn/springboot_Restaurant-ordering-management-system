    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">餐厅点餐管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="店家名称" class="input" v-if="tableName=='shangjia'">
                            <el-input v-model="ruleForm.shangjiaName" autocomplete="off" placeholder="店家名称"  />
                        </el-form-item>
                        ...
                        -->
                        <!--
                            <el-form-item label="店家类型" class="input" v-if="tableName=='shangjia'">
                                <el-input v-model="ruleForm.shangjiaTypes" autocomplete="off" placeholder="店家类型"  />
                           </el-form-item>
                        -->
                        <!--
                        ...
                        -->
                        <!--
                            <el-form-item label="店家介绍" class="input" v-if="tableName=='shangjia'">
                                <el-input type="textarea" v-model="ruleForm.shangjiaContent" placeholder="店家介绍"></el-input>
                           </el-form-item>
                        -->
                        <!--
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/cantingdiancai/img/back-img-bg.jpg);
