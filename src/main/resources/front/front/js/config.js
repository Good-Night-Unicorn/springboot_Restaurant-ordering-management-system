...
var centerMenu = [
    ...
    ,{
        name: '商品评价',
        url: '../shangpinCommentback/list.html'
    }
    ,{
        name: '商品订单',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/cantingdiancai/admin/dist/index.html#/login";
